...
object Programs {
    ...
    fun create_program_for(args: Array<String>): Program {
        ...
        return when {
            ...
            pa.has_open_command() -> OpenPullRequestsProgram(ui, pa, baseUrl, repoUrl, pa.get_github_auth_token(), githubApiClient, httpClientStats)
            ...
            pa.has_close_command() -> ClosePullRequestsPrograms(ui, pa, repoUrl, githubApiClient, httpClientStats)
